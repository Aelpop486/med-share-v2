<template>
    <!-- @/Images/Group.svg bg-violet-700 -->
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="mx-auto grid max-w-lg grid-cols-1 gap-y-12 lg:max-w-full lg:grid-cols-2 lg:items-center lg:gap-x-8">
          ...
          <div class="text-center lg:text-left">
            <h1 class="max-w-md text-4xl text-slate-700 font-bold leading-snug sm:text-5xl sm:leading-snug">
              ...
              3D <br class="hidden sm:block" />
               with <span class="rounded-xl bg-[#0155A5] px-2 pb-2 text-white">Spline</span>
            </h1>
            ...
            <div class="mt-8 flex flex-col items-center justify-center sm:flex-row sm:space-x-4 lg:justify-start">
              <button class="relative mt-4 rounded-lg border-2 border-[#0155A5] bg-[#0155A5] px-6 py-2 font-medium text-white transition hover:translate-y-1">
                <div class="-scale-x-100 absolute left-0 -bottom-10 hidden h-10 w-10 -rotate-12 text-[#0155A5] md:inline-flex">
              ...
              <button class="mt-4 flex items-center rounded-lg border-2 border-[#0155A5] px-6 py-2 font-medium text-slate-700 transition hover:translate-y-1 hover:text-white hover:bg-[#0155A5]">
                Watch the demo
        ...
        <div class=" bg-violet-100 lg:bg-transparent">
          <div class=" right-0 bottom-0 hidden overflow-hidden lg:inset-y-0 lg:block">
          </div>
