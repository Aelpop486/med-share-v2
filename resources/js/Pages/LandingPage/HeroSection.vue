        ...
        <div>
          <div class="text-center lg:text-left">
            ...
            <div class="mt-8 flex flex-col items-center justify-center sm:flex-row sm:space-x-4 lg:justify-start">
              ...
              <a :href="route('About')" type="button" class="mt-4 flex items-center rounded-lg border-2 dark:text-white border-[#1e429f] px-6 py-2 font-medium text-slate-700 transition hover:translate-y-1 hover:text-white hover:bg-[#1e429f]">
                Watch the demo
