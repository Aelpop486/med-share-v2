            ...
            >
                <div>
                    <div class="text-center lg:text-left">
                        <h1
                            class="max-w-md text-4xl text-slate-700 dark:text-white font-bold leading-snug sm:text-5xl sm:leading-snug"
                        >
                            We offer software that makes the donation process
                            easier Significantly
                        </h1>
                        <p
                            class="mt-2 text-lg font-bold dark:text-white text-slate-600 sm:mt-8"
                        >
                            Users can do this by uploading a picture of the
                            previously used treatment only. Once the photo is
                            uploaded, we, as an intermediary, organize the
                            process of collecting the treatment and delivering
                            it to people in need in cooperation with the charity
                        </p>
                        <div
                            class="mt-8 flex flex-col items-center justify-center sm:flex-row sm:space-x-4 lg:justify-start"
                        >
                            <button
                                class="relative dark:text-white mt-4 rounded-lg border-2 border-[#1e429f] bg-[#1e429f] px-6 py-2 font-medium text-white transition hover:translate-y-1"
                            >
                                <div
                                    class="-scale-x-100 absolute left-0 -bottom-10 hidden h-10 w-10 -rotate-12 text-blue-700 md:inline-flex"
                                >
                                    <svg
                                        viewBox="0 0 82 35"
                                        fill="none"
                            ...
                            <a
                                :href="route('About')"
                                type="button"
                                class="mt-4 flex items-center rounded-lg border-2 dark:text-white border-[#1e429f] px-6 py-2 font-medium text-slate-700 transition hover:translate-y-1 hover:text-white hover:bg-[#1e429f]"
                            >
                                Watch the demo
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="bg-violet-100 lg:bg-transparent">
                    <div
                        class="right-0 bottom-0 hidden overflow-hidden lg:inset-y-0 lg:block"
                    ></div>
