            ...
            <div class="max-w-3xl mx-auto">
                <a href="/" class="flex justify-center">
                    <div class="flex items-center gap-2">
                        <div class="font-bold text-2xl leading-4">
                            <p>
                                Med
                ...
                <div class="flex space-x-10 justify-center items-center mb-14">
                    <a
                        href="#"
                        class="block text-white transition-all duration-500 hover:text-indigo-600"
                    >
                        <svg
                    ...
                    <a
                        href="#"
                        class="block textwhite transition-all duration-500 hover:text-indigo-600"
                    >
                        <svg
                            class="w-[1.688rem] h-[1.688rem]"
                            viewBox="0 0 29 29"
                ...
                <span class="text-lg text-white text-center block"
                    >©<a href="https://pagedone.io/">pagedone</a> 2024, All
