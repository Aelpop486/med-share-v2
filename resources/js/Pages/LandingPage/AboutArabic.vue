<template>
    ...
    <body class="font-inter">
        <section class="py-14 lg:py-24 bg-gray-50">
            ...
            <p class=" mx-auto text-center text-base font-bold leading-7 text-gray-500 mb-9">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-9 ">
                    ...
                    <div class="lg:pr-24 flex items-center">
                        <div class="data w-full">
                            ...
                            <h2 class="font-manrope font-bold text-xl lg:text-5xl text-black mb-9 max-lg:text-center text-right">
                                فريق يسعى لتغيير حياة الآخرين بأدوية غير مستخدمة
                                </h2>
                             <p class="font-normal text-md leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto text-right">
