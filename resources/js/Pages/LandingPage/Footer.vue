        ...
        <div class="mx-auto text-white max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto">
                ...
                <div class="flex space-x-10 justify-center items-center mb-14">
                    ...
                    <a href="#" class="block  textwhite transition-all duration-500 hover:text-indigo-600 ">
                ...
                <span class="text-lg text-white text-center block">©<a href="https://pagedone.io/">pagedone</a> 2024,
