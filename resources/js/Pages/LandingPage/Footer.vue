...
<footer>
    <div class="bg-[#0155A5] py-4 text-white font-bold sm:text-center">
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 my-4 w-full xl:w-1/5">
            <a href="/" class=" font-bold text-2xl w-56 mb-10 flex space-x-2">
                <img src="@/Images/IMG_1525.svg" class="h-8 " alt="">
                <p class="">
                    Med<span class=" text-lime-500">Share</span>
                </p>
            </a>
          ...
          <div class="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 class="inline-block text-2xl pb-4 mb-4 ">Blog</h2>
            </div>
            <ul class="leading-8">
          ...
          <div class="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            <div>
              <h2 class="inline-block text-2xl pb-4 mb-4 ">Connect With Us</h2>
            </div>
            <a href="#" class="inline-flex items-center justify-center h-8 w-8 rounded-full mr-1 hover:text-blue-400 hover:border-blue-400">
    ...
    <div class="bg-[#0155A5] py-4 text-gray-100">
