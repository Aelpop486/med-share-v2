<template>
        ...
        <div class="w-full dark:bg-gray-900 dark:text-white">
            <div class="w-full">
                ...
                <h1 class="mb-8 text-center text-gray-900 font-bold font-manrope leading-tight lg:text-5xl text-3xl dark:text-white">
                    PRIVACY POLICY
                </h1>
            </div>
                    ...
                    <div class="flex flex-col md:flex-row w-full gap-8">
                        <div class="w-full md:max-w-[176px] md:border-r md:border-gray-200">
                            <ul class="tab-nav flex flex-col md:items-start items-center lg:gap-10 gap-6">
                                 <li>
                                    <a href="#"
                                        class="font-medium text-base leading-7 hover:text-indigo-600 text-indigo-600 dark:text-white">Privacy Policy
                                        </a>
                                </li>
                                <li>
                                    <a :href="route('pages')" class="font-medium text-base leading-7 dark:text-white">Terms of Services</a>
                                </li>
                        ...
                        <div class="w-full tab-pane max-md:px-4">
                            ...
                            <div class="flex items-center gap-3 lg:mb-10 mb-8">
                                ...
                                <p class="font-medium text-xl leading-8 text-indigo-600 dark:text-white">
                                    Last updated: April 28, 2024
                                </p>
                            </div>
                            <p class="font-bold text-[13px] lg:text-lg text-gray-500 mb-5 dark:text-white">
                                ...
                                ("Services"), such
                                as when you:
                                Download and use our mobile application (MedShare ) , or any other application of ours
                                that links to
                                this privacy notice
                            ...
                            <p class="font-bold text-[13px] leading-8 text-gray-500 lg:mb-10 mb-8 dark:text-white">

                                SUMMARY OF KEY POINTS <br>

                                This summary provides key points from our privacy notice, but you can find out more
                                details about
                                any of these topics by clicking the link following each key point or by using our table
                                of contents
                                below to find the section you are looking for.

                                What personal information do we process? When you visit, use, or navigate our Services,
                                we may
                                process personal information depending on how you interact with us and the Services, the
                                choices you
                                make, and the products and features you use. Learn more about personal information you
                                disclose to
                                us.
                                ...
                                information
                                in specific situations and with specific third parties. Learn more about when and with
                                whom we share
                                your personal information.

                                How do we keep your information safe? We have organizational and technical processes and
                                procedures
                                in place to protect your personal information. However, no electronic transmission over
                                the internet
                                ...
                                submitting a data
                                subject access request , or by contacting us. We will consider and act upon any request
                                in
                            ...
                            <h5 class="font-bold md:text-xl text-md text-gray-900 mb-4 dark:text-white">
                                TABLE OF CONTENTS
                            </h5>
                            <ul class="ml-8 lg:mb-10 mb-8 font-bold md:text-xl text-[15px] dark:text-white">
                                <li class="list-decimal text-gray-500 dark:text-white">
                                    <a href="#01 dark:text-white">WHAT INFORMATION DO WE COLLECT?</a>
                                </li>
                                <li class="list-decimal text-gray-500 dark:text-white">
                                    <a href="#02">HOW DO WE PROCESS YOUR INFORMATION?</a>
                                </li>
                                <li class="list-decimal text-gray-500 dark:text-white">
                                    <a href="#03 dark:text-white">WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION</a>
                                </li>
                                <li class="list-decimal text-gray-500 dark:text-white">
                                    <a href="#04 dark:text-white">DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</a>
                                </li>
                                <li class="list-decimal text-gray-500 dark:text-white">
                                    <a href="#05"> HOW DO WE HANDLE YOUR SOCIAL LOGINS?</a>
                                </li>
                                <li class="list-decimal text-gray-500 dark:text-white">
                                    <a href="#06 dark:text-white"> HOW LONG DO WE KEEP YOUR INFORMATION?</a>
                                </li>
                                <li class="list-decimal text-gray-500 dark:text-white">
                                    <a href="#07 dark:text-white"> HOW DO WE KEEP YOUR INFORMATION SAFE?</a>
                                </li>
                                <li class="list-decimal text-gray-500 dark:text-white">
                                    <a href="#08 dark:text-white">DO WE COLLECT INFORMATION FROM MINORS?</a>
                                </li>
                                <li class="list-decimal  text-gray-500 dark:text-white">
                                    <a href="#09 dark:text-white"> WHAT ARE YOUR PRIVACY RIGHTS?</a>
                                </li>
                                <li class="list-decimal  text-gray-500 dark:text-white">
                                    <a href="#10 dark:text-white">CONTROLS FOR DO-NOT-TRACK FEATURES</a>
                                </li>
                                <li class="list-decimal  text-gray-500 dark:text-white">
                                    <a href="#11 dark:text-white">DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</a>
                                </li>
                                <li class="list-decimal text-gray-500 dark:text-white">
                                    <a href="#12 dark:text-white">DO WE MAKE UPDATES TO THIS NOTICE?</a>
                                </li>
                                <li class="list-decimal text-gray-500 dark:text-white">
                                    <a href="#13 dark:text-white">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a>
                                </li>
                                <li class="list-decimal text-gray-500 dark:text-white">
                                    <a href="#14 dark:text-white"> HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM
                                        YOU?</a>
                                </li>
                            </ul>
                            <ul
                                ...
                                <li id="01" class="list-decimal">
                                    ...
                                    <p class="mt-5 font-bold text-[13px] leading-8 text-gray-500 dark:text-white">
                                        ...
                                        using your existing social media account details, like your Facebook, Twitter,
                                        or other social media account. If you choose to register in this way, we will
                                ...
                                <li id="03" class="list-decimal">
                                    ...
                                    <p class="mt-5 font-normal text-lg leading-8 text-gray-500 dark:text-white">
                                        ...
                                        certain Google Maps Platform APIs (e.g. , Google Maps API, Places API). We use
                                        certain Google Maps Platform APIs to retrieve certain information when you make
                                        location-specific requests. This includes: City ; Area ; Building ; Floor ; Flat
                                        numer ; and other similar information. A full list of what we use information
                                        for can be found in this section and in the previous section titled " HOW DO WE
                                        PROCESS YOUR INFORMATION? " We obtain and store on your device ( "cache" ) your
                                        location . You may revoke your consent anytime by contacting us at the contact
                                        details provided at the end of this document. The Google Maps Platform APIs that
                                        we use store and access cookies and other information on your devices. If you
                                        are a user currently in the European Economic Area (EU countries, Iceland,
                                ...
                                <li id="011" class="list-decimal">
                                    ...
                                    <p class="mt-5 font-bold text-[13px] leading-8 text-gray-500 dark:text-white">
                                        ...
                                        This privacy notice satisfies the notice requirements defined in the Privacy Act
                                        , in particular: what personal information we collect from you, from which
                                        ...
                                        contact details provided in the section " HOW CAN YOU REVIEW, UPDATE, OR DELETE
                                        ...
                                        Principles to the Office of the Australian Information Commissioner .
