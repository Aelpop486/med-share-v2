<template>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
                <div class="bg-violet-100 lg:bg-transparent">
                    <div
                        class="left-0 bottom-0 hidden overflow-hidden lg:inset-y-0 lg:block"
                    ></div>
                ...
                <div>
                    <div class="">
                        ...
                        >
                            ...
                            كوسيط بتنظيم عملية جمع العالج وإيصاله إلى المحتاجين
    ...
    <section class="bg-[#f3f4f6] dark:bg-gray-900 ">
        <div class="container px-6 py-10 mx-auto">
            ...
            >
                التعاون مع أكبر الجمعيات الخيرية
            </h1>
            ...
            >
                <div
                    ...
                    style="
                        background-image: url('https://mekeg.org/assets/v2/img/logo-en.svg');
                    "
                >
                    <div
                ...
                <div
                    class="overflow-hidden bg-cover rounded-lg cursor-pointer h-96 group"
                    style="
                        background-image: url('https://ahl-masr.ngo/wp-content/webp-express/webp-images/doc-root/wp-content/uploads/2024/03/cropped-1-01-scaled-e1709765234602.jpg.webp');
                    "
                >
                    <div
                        class="flex flex-col justify-center w-full h-full px-8 py-4 transition-opacity duration-700 opacity-0 backdrop-blur-sm bg-gray-800/60 group-hover:opacity-100"
    ...
    <section class="py-14 bg-[#f3f4f6] dark:bg-gray-900 dark:text-white">
        <div class="max-w-screen-xl mx-auto md:px-8">
            <div class="items-center gap-x-12 sm:px-4 md:px-0 lg:flex">
                ...
                >
                    <h3 class="text-[#0155A5] font-semibold text-right">
                        مهمتنا
                    </h3>
                    <p
                    ...
                    <p class="mt-3 text-gray-600 text-right dark:text-white">
                        ...
                        الطبية والجمعيات الخيرية لتعزيز فعالية التوزيع عمليات.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-[#f3f4f6] pt-20 dark:bg-gray-900 dark:text-white">
        ...
        <video
            class="pb-20 mx-auto h-[40%] w-[70%] rounded-lg"
            autoplay
            loop
            muted
        >
            <source
                src="@/Images/WhatsApp Video 2024-04-23 at 12.26.03 AM.mp4"
                type="video/mp4"
            />
        </video>
    </div>
