            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <a href="#"
                            class="ms-1 text-sm font-medium text-slate-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Donation Management</a>
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <a href="#"
                            class="ms-1 text-sm font-medium text-slate-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Donation Profile</a>
                    </div>
                </li>
